...
<nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
    <a class="navbar-brand" href="/doctor-panel">{{--{{ \App\Setting::where('key', '=', 'site_name')->first()->value }}--}}Control Panel</a>
...
<div id="layoutSidenav">
    @include('navbar_doctor')
    <div id="layoutSidenav_content">
    <header class="page-header page-header-dark bg-blue pb-5">
            <div class="container">
