...
<div id="layoutSidenav">
    @include('navbar_patient')
    <div id="layoutSidenav_content">
    <header class="page-header page-header-dark bg-green pb-5">
            <div class="container">
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-12 col-md-6 mt-4 text-right">
                            ...
                            <a href="/patient-panel" class="btn btn-outline-white rounded-pill btn-sm ml-1" role="button">exit <i class="fas fa-arrow-left ml-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
