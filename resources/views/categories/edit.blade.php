                  ...
                  <div class="row m-5">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">{{$category->name}} image</div>
                                    <div class="card-body text-center">
                                        <!-- Category image-->
                                        <img id="category-image" width="160" height="160" class="img-account-profile  mb-1" src="{{ isset($category->img)? asset('categoryImages/'.$category->img): '/assets/img/noimg.jpg' }}" alt="main pic" />
                                       
                                        <form  method="POST" action="{{ route('categories.update', $category->id ) }}" enctype="multipart/form-data" id="image-form">
                                        @csrf
                                        @method('PUT')
